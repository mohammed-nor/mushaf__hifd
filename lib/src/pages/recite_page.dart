  ...
  Future<void> _generateRandomThomun() async {
    ...
    if (_onlyLearned) {
      ...
      if (learnedList.isNotEmpty) {
        ...
        final filtered = learnedList.map(int.tryParse).whereType<int>().where((i) => i >= 0 && i < kThomuns.length).map((i) => kThomuns[i]).toList();
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.transparent,
          elevation: 0,
          title: Text(_currentThomun != null ? 'تلاوة: ${_currentThomun!.replaceAll('.png', '')}' : 'إمتحن حفظك', style: const TextStyle(fontWeight: FontWeight.w600, letterSpacing: 1.2)),
          centerTitle: true,
          actions: [
            IconButton(
                ...
                child: _currentThomun != null
                    ? Hero(
                        ...
                        child: AnimatedSwitcher(
                          ...
                          child: Image.asset('lib/thomuns/$_currentThomun', key: ValueKey<String>(_currentThomun!), fit: BoxFit.contain, width: double.infinity, height: double.infinity),
                        ),
                      )
                    : Center(
                        child: Column(
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF64FFDA).withAlpha(77), // 0.3 opacity
                        blurRadius: 15,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF12121D)),
                        ),
                      ],
                    ),
                  ),
